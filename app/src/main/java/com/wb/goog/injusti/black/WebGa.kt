...
import com.wb.goog.injusti.AppGa.Companion.MAIN_ID
import com.wb.goog.injusti.R
import com.wb.goog.injusti.databinding.ActivityWebGaBinding
import org.json.JSONException
import org.json.JSONObject
import java.io.File
import java.io.IOException

class WebGa : AppCompatActivity() {
    ...
    lateinit var bind: ActivityWebGaBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityWebGaBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val first = "http://"
        val second = "aztecsun.xyz/go.php?to=2&"
